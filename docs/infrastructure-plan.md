...
<table>
  ...
  <tbody>
    <tr>
      <td><strong>LB-01</strong></td>
      <td><code>ssh -i ~/.ssh/yandex_cloud ubuntu@111.88.241.156</code></td>
    </tr>
    <tr>
      <td><strong>APP-01</strong></td>
      <td><code>ssh -J ubuntu@111.88.241.156 ubuntu@10.0.2.10 -i ~/.ssh/yandex_cloud</code></td>
    </tr>
    <tr>
      <td><strong>APP-02</strong></td>
      <td><code>ssh -J ubuntu@111.88.241.156 ubuntu@10.0.2.11 -i ~/.ssh/yandex_cloud</code></td>
    </tr>
    <tr>
      <td><strong>DB-01</strong></td>
      <td><code>ssh -J ubuntu@111.88.241.156 ubuntu@10.0.3.10 -i ~/.ssh/yandex_cloud</code></td>
    </tr>
    <tr>
      <td><strong>DB-02</strong></td>
      <td><code>ssh -J ubuntu@111.88.241.156 ubuntu@10.0.3.11 -i ~/.ssh/yandex_cloud</code></td>
    </tr>
    <tr>
      <td><strong>ZABBIX-01</strong></td>
      <td><code>ssh -J ubuntu@111.88.241.156 ubuntu@10.0.4.10 -i ~/.ssh/yandex_cloud</code></td>
    </tr>
    <tr>
      <td><strong>BACKUP-01</strong></td>
      <td><code>ssh -J ubuntu@111.88.241.156 ubuntu@10.0.5.10 -i ~/.ssh/yandex_cloud</code></td>
    </tr>
  </tbody>
</table>
...
```ini
[lb]
lb-01 ansible_host=111.88.241.156
